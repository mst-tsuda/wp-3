...
<div class="header">
  <div class="container">
    ...
    <div class="menu">
	   <a class="toggleMenu" href="#"><img src="<?php echo get_template_directory_uri(); ?>/images/menu.png" alt="" /> </a>
	   <ul class="nav" id="nav">
...
<!-- start light_box -->
<link rel="stylesheet" type="text/css" href="<?php echo get_stylesheet_directory_uri(); ?>/css/jquery.fancybox.css" media="screen" />
